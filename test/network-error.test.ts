...
describe('getNetworkErrorCode', () => {
	it('prefers code over name', () => {
		assert.equal(getNetworkErrorCode({ code: 'ENOTFOUND', name: 'Error', value: '{}' }), 'ENOTFOUND');
	});
...
describe('getNetworkErrorMessage', () => {
	it('embeds the code and selects the matching category text', () => {
		...
		assert.match(getNetworkErrorMessage('CERT_HAS_EXPIRED'), /TLS\/certificate verification failed/);
	});
