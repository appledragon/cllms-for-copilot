...
export const VISION_PROXY_CONFIG_KEY = 'cllms.visionProxy.config';
export const VISION_PROXY_SOURCE_KEY = 'cllms.visionProxy.source';
export const VISION_PROXY_API_KEY_SECRET = 'cllms.visionProxy.apiKey';
