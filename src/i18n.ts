...
const zh: Translations = {
	...
	'providers.webview.intro': '管理各服务商的 API Key、连接与模型。',
	'providers.webview.endpointLabel': '端点',
	'providers.section.models': '模型',
	'providers.section.more': '更多操作',
	...
	'providers.toolbar.visionModel': '设置视觉模型',
	'providers.toolbar.settings': '打开设置',
	'providers.toolbar.logs': '查看日志',
	'providers.toolbar.diagnostics': '复制诊断报告',
	'providers.toolbar.walkthrough': '入门指引',
...
const en: Translations = {
	...
	'providers.webview.intro': 'Manage each provider API key, connection, and models.',
	'providers.webview.endpointLabel': 'Endpoint',
	'providers.section.models': 'Models',
	'providers.section.more': 'More Actions',
	...
	'providers.toolbar.visionModel': 'Set Vision Model',
	'providers.toolbar.settings': 'Open Settings',
	'providers.toolbar.logs': 'Show Logs',
	'providers.toolbar.diagnostics': 'Copy Diagnostic Report',
	'providers.toolbar.walkthrough': 'Walkthrough',
